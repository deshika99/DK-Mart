        ...
        <div class="row gy-4 justify-content-center">
            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="border border-gray-100 hover-border-main-600 transition-1 rounded-16 px-24 py-40">
                    ...
                    <!-- Username -->
                    <div class="mb-24">
                        <x-input-label class="fw-bold"  for="name" :value="__('Username')" />
                        <span class="text-danger">*</span>
                        <x-text-input id="name" class="common-input w-100" type="text" name="name" :value="old('name')" placeholder="Write a username" required autofocus autocomplete="name" />
