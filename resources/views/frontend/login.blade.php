                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="border border-gray-100 hover-border-main-600 transition-1 rounded-16 px-24 py-40">
                        ...
                        <div class="mb-24">
                            ...
                            <input type="text" class="common-input w-100" id="username" placeholder="First Name">
                        </div>
                        <div class="mb-24">
                            <label for="password" class="text-neutral-900 text-lg mb-8 fw-medium">Password</label>
                            <div class="position-relative">
                                <input type="password" class="common-input w-100" id="password" placeholder="Enter Password">
