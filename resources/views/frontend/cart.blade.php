                            ...
                            <table class="table style-three">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-lg h6 mb-0 fw-semibold">Rs {{ number_format($item->price, 2) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-lg h6 mb-0 fw-semibold">Rs {{ number_format($item->subtotal, 2) }}</span>
                                        </td>
                                        <td>
                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="bg-color-three rounded-8 p-24 mt-24">
                        <div class="flex-between gap-8">
                            ...
                            <span class="text-gray-900 text-xl fw-semibold">Rs {{ number_format($cartItems->sum('subtotal') + 300, 2) }}</span>
                        </div>
                    </div>
