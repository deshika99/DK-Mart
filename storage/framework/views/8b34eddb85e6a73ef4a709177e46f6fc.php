...
<form method="POST" action="<?php echo e(route('vendor.products.store')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<div class="row">
    <div class="col-12">
...
<?php echo $__env->make('VendorDashboard.Vendormaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/VendorDashboard/add_products.blade.php ENDPATH**/ ?>