        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-9">
                <section class="content-body p-xl-4">
                    <!-- General Section -->
                    <form id="generalSection" action="<?php echo e(route('vendor.updateProfile')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row gx-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" id="name" name="name" value="<?php echo e($vendor->name); ?>" required placeholder="Type here" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Email</label>
                                        <input class="form-control" type="email" id="email" name="email" value="<?php echo e($vendor->email); ?>" required placeholder="example@mail.com" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Phone</label>
                                        <input class="form-control" type="tel" id="contact" name="contact" value="<?php echo e($vendor->phone); ?>" required placeholder="+1234567890" />
                                    </div>
                                </div>
                            </div>
                            <aside class="col-lg-4">
                            <figure class="text-lg-center">
                                <img id="profileImage" src="<?php echo e(asset('storage/' . $vendor->profile_image  ?? 'default-user.png')); ?>" alt="Profile Image" class="img-lg mb-3 img-avatar">
                                <figcaption>
                                    <!-- Hidden file input -->
                    ...
                    <!-- Password Section -->
                    <form action="<?php echo e(route('vendor.updatePassword')); ?>" method="POST" id="passwordSection" style="display: none;">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <?php if($errors->any()): ?>
                    ...
                    <!-- Bank Section -->
                    <form id="bankSection" action="<?php echo e(route('vendor.updateBankDetails')); ?>" method="POST" enctype="multipart/form-data" style="display: none;">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row gx-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" id="bank_name" name="bank_name" value="<?php echo e($vendor->bank_name); ?>" placeholder="Bank Name" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Branch</label>
                                        <input class="form-control" type="text" id="branch" name="branch" value="<?php echo e($vendor->branch); ?>" placeholder="Branch" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Account Name</label>
                                        <input class="form-control" type="text" id="account_name" name="account_name" value="<?php echo e($vendor->account_name); ?>" placeholder="Account Name" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Account Number</label>
                                        <input class="form-control" type="text" id="account_number" name="account_number" value="<?php echo e($vendor->account_number); ?>" placeholder="Account Number" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('VendorDashboard.Vendormaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views/VendorDashboard/profile.blade.php ENDPATH**/ ?>