...
<head>
    ...
    <title> DK-Mart</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('frontend/assets/images/logo/favicon.png')); ?>">
...
<?php echo $__env->make('includes.navbar-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="preloader">
    <img src="<?php echo e(asset('frontend/assets/images/icon/preloader.gif')); ?>" alt=""></div>
