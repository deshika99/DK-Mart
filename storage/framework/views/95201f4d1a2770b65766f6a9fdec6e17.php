         ...
         <div class="d-flex align-items-center justify-content-between flex-wrap mb-48 gap-16">
             ...
             <div class="d-flex align-items-center justify-content-between justify-content-sm-end gap-16 flex-grow-1">
                <div class="text-gray-600 text-md flex-shrink-0">
                    <span class="text-neutral-900 fw-semibold"><?php echo e($totalResults); ?></span> Results Found
                </div>
                ...
                <div class="shop-sidebar">
                    ...
                    <div class="d-flex flex-column gap-12 px-lg-0 px-3 py-lg-0 py-4">
                        <div class="border border-gray-50 rounded-8 p-24">
                            ...
                            <form action="<?php echo e(route('frontend.vendor')); ?>" method="GET">
                                <div class="d-flex flex-column gap-8">
                                    <input type="text" class="common-input" name="location" placeholder="Location" value="<?php echo e(request('location')); ?>">
                                </div>
            ...
            <div class="col-xl-9 col-lg-8">
             <!-- Vendors Start -->
                            ...
                            <div class="vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2">
                                <div class="vendors-two-item__top bg-overlay style-two position-relative">
                                    <div class="vendors-two-item__thumbs h-210">
                                        ...
                                        <?php if($vendor->shop->shop_logo): ?>
                                            <img src="<?php echo e(asset('storage/' . $vendor->shop->shop_logo)); ?>" alt="" class="cover-img">
                                        <?php else: ?>
                                    ...
                                    <div class="position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <?php if($vendor->shop->shop_logo): ?>
                                                <img src="<?php echo e(asset('storage/' . $vendor->shop->shop_logo)); ?>" alt="" class="cover-img rounded-circle ">
                                            <?php else: ?>
                                        ...
                                        <div class="mt-16">
                                            <h6 class="text-white fw-semibold mb-12">
                                                <a href="<?php echo e(route('frontend.vendor.details', $vendor->id)); ?>" class=""><?php echo e($vendor->shop->shop_name); ?></a>
                                            </h6>
                                ...
                                <div class="vendors-two-item__content p-24 flex-grow-1">
                                    <div class="d-flex flex-column gap-14">
                                        <div class="flex-align gap-8">
                                            ...
                                            <p class="text-md text-gray-900"><?php echo e($vendor->address); ?></p>
                                        </div>
                                        <div class="flex-align gap-8">
                                            <span class="flex-center text-main-two-600 text-2xl flex-shrink-0">
                                                <i class="ph ph-envelope-simple"></i>
                                            </span>
                                            <a href="mailto:<?php echo e($vendor->email); ?>" class="text-md text-gray-900 hover-text-main-60"><?php echo e($vendor->email); ?></a>
                                        </div>
                                        <div class="flex-align gap-8">
                                            <span class="flex-center text-main-two-600 text-2xl flex-shrink-0">
                                                <i class="ph ph-phone"></i>
                                            </span>
                                            <a href="tel:<?php echo e($vendor->phone); ?>" class="text-md text-gray-900 hover-text-main-60"><?php echo e($vendor->phone); ?></a>
                                        </div>
                                    </div>
                                    <a href="<?php echo e(route('frontend.vendor.details', $vendor->id)); ?>" class="btn bg-neutral-600 hover-bg-neutral-700 text-white py-12 px-24 rounded-8 flex-center gap-8 fw-medium mt-24">
                                        Visit Store
                ...
                <ul class="pagination flex-center flex-wrap gap-16">
                    ...
                    <li class="page-item">
                        <a class="page-link h-44 w-44 flex-center text-xxl rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($vendors->previousPageUrl()); ?>">
                            <i class="ph-bold ph-arrow-left"></i>
                        </a>
                    </li>
                    
                    <!-- Page numbers -->
                    <?php $__currentLoopData = $vendors->getUrlRange(1, $vendors->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="page-item <?php echo e($page == $vendors->currentPage() ? 'active' : ''); ?>">
                            <a class="page-link h-44 w-44 flex-center text-md rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($url); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <!-- Next page button -->
                    <li class="page-item">
                        <a class="page-link h-44 w-44 flex-center text-xxl rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($vendors->nextPageUrl()); ?>">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/frontend/vendor.blade.php ENDPATH**/ ?>