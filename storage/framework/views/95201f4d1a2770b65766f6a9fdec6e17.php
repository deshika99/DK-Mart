            ...
            <div class="col-xl-9 col-lg-8">
             <!-- Vendors Start -->
                ...
                <ul class="pagination flex-center flex-wrap gap-16">
                    ...
                    <li class="page-item">
                        <a class="page-link h-64 w-64 flex-center text-xxl rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($vendors->previousPageUrl()); ?>">
                    ...
                    <?php $__currentLoopData = $vendors->getUrlRange(1, $vendors->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="page-item <?php echo e($page == $vendors->currentPage() ? 'active' : ''); ?>">
                            <a class="page-link h-64 w-64 flex-center text-md rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($url); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <!-- Next page button -->
                    <li class="page-item">
                        <a class="page-link h-64 w-64 flex-center text-xxl rounded-8 fw-medium text-neutral-600 border border-gray-100" href="<?php echo e($vendors->nextPageUrl()); ?>">
