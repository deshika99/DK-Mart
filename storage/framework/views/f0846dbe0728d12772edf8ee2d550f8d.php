        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-9">
                <section class="content-body p-xl-4">
                    <!-- General Section -->
                    <form id="generalSection" action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row gx-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" id="name" name="name" value="<?php echo e($admin->name); ?>" required placeholder="Type here" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Email</label>
                                        <input class="form-control" type="email" id="email" name="email" value="<?php echo e($admin->email); ?>" required placeholder="example@mail.com" />
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label class="form-label">Phone</label>
                                        <input class="form-control" type="tel" id="contact" name="contact" value="<?php echo e($admin->contact); ?>" required placeholder="+1234567890" />
                                    </div>
                                </div>
                            </div>
                            <aside class="col-lg-4">
                                <figure class="text-lg-center">
                                    <img id="profileImage" src="<?php echo e(asset('storage/user_images/' . session('image', 'default-user.png'))); ?>" alt="Profile Image" class="img-lg mb-3 img-avatar">
                                    <figcaption>
                                        <!-- Hidden file input -->
                    ...
                    <!-- Password Section -->
                    <form action="<?php echo e(route('admin.profile.password.update')); ?>" method="POST" id="passwordSection" style="display: none;">
                    <?php echo csrf_field(); ?>
                        <div class="row">
                        <?php if($errors->any()): ?>
