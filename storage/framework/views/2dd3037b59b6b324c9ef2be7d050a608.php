...
<style>
    ...
    .form-control {
            ...
            .main {
                text-align: center;
                padding: 50px 0;
                background-image: url('/frontend/assets/images/team-meet-scaled.jpg'); 
                    ...
                    <div class="col-md-4 d-flex justify-content-center justify-content-md-start align-items-center mb-md-0">
                        <a href="#" class="d-flex align-items-center" style="text-decoration: none">
                            <div class="navbar-brand">
                                <img src="/frontend/assets/images/logo/logo-two-black.png" height="100" width="100" alt="Logo"/>
                            </div>
                        ...
                        <div class="col-md-3 d-flex justify-content-center justify-content-md-end align-items-center">
                            <div class="d-flex align-items-center">                      
                                    ...
                                    <a class="text-reset me-3 signup-btn p-2" href="<?php echo e(route('affiliate_register')); ?>">
                                        <div style="font-weight:500; color:white">
                                            SIGN UP
                                        </div>
                                    </a>
...
<?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/AffiliateDashBoard/affiliate_home.blade.php ENDPATH**/ ?>