...
<div class="content-header">
    <div>
        <h2 class="content-title card-title">Withdrawals</h2>
        <p>You  can Request Affiliate Payments & You Can see your progress </p>
    </div>
            ...
            <div class="col-md-6 col-12 mb-4"> 
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-2 text-danger">Check your balance; it must be more than 1000 before requesting a withdrawal.</p>
...
<?php echo $__env->make('AffiliateDashBoard.affmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/AffiliateDashBoard/withdrawals.blade.php ENDPATH**/ ?>