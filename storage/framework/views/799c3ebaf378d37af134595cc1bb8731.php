                ...
                <div class="col-lg-12">
                    <div class="row gx-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="footer_text" placeholder="Type here" value="<?php echo e(old('footer_text', $company->footer_text ?? '')); ?>" />
                        </div>
...
<?php echo $__env->make('AdminDashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views/AdminDashboard/manage_company.blade.php ENDPATH**/ ?>