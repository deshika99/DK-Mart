...
<form method="POST" action="<?php echo e(route('vendor.products.update', $product->id)); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <label class="form-check mb-4">
                        <input name="is_affiliate" id="affiliate_checkbox" class="form-check-input" type="checkbox" <?php echo e($product->is_affiliate ? 'checked' : ''); ?> />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input name="affiliate_price" id="affiliate_price" value="<?php echo e(old('affiliate_price', $product->affiliate_price)); ?>" placeholder="Rs" type="number" class="form-control" readonly />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input name="commission_percentage" id="commission" value="<?php echo e(old('commission_percentage', $product->commission_percentage)); ?>" type="number" placeholder="%" class="form-control" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <label class="form-label">Commission price</label>
                                <input name="com_price" id="com_price" value="<?php echo e(old('commission_price', $product->commission_price)); ?>" placeholder="Rs" type="number" class="form-control" readonly />
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // Add event listener for existing images
    imagePreviewContainer.addEventListener('click', function (event) {
        if (event.target.classList.contains('delete-existing-image')) {
            ...
            deletedImagesInput.value = JSON.stringify(deletedImages); // Update the hidden input with deleted image IDs
...
<?php echo $__env->make('VendorDashboard.Vendormaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views/VendorDashboard/edit_products.blade.php ENDPATH**/ ?>