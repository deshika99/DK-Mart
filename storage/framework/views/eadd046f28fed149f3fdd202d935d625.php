...
<div class="card">
    <header class="card-header">
        <div class="row align-items-center">
            ...
            <form id="update-status-form-<?php echo e($order->order_code); ?>" action="<?php echo e(route('vendor.order.updateStatus', $order->order_code)); ?>" method="POST" class="d-inline">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>
                <select name="status" class="form-select d-inline-block mb-lg-0 mr-5 mw-200" 
                        <?php echo e(in_array($order->status, ['Packed', 'Pickup Done', 'Ready to Ship']) ? 'disabled' : ''); ?>>
                ...
                <button type="button" class="btn btn-primary p-2" onclick="confirmUpdate('<?php echo e($order->order_code); ?>')">Update</button>
            </form>
...
<?php echo $__env->make('VendorDashboard.Vendormaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DK-Mart\resources\views/VendorDashboard/order-details.blade.php ENDPATH**/ ?>