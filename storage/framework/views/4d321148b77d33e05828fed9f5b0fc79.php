                            ...
                            <div class="col-lg-10 col-md-8">
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form  method="POST" action="<?php echo e(route('affiliate.register')); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/AffiliateDashBoard/affRegister.blade.php ENDPATH**/ ?>