...
<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
            ...
            <nav>
                <ul class="menu-aside">
                    ...
                    <li class="menu-item <?php echo e(request()->routeIs('affiliate_customers') ? 'active' : ''); ?>">
                        <a class="menu-link" href="<?php echo e(route('affiliate_customers')); ?>">
                    ...
                    <li class="menu-item <?php echo e(request()->routeIs('sellers') ? 'active' : ''); ?>">
                        <a class="menu-link" href="<?php echo e(route('sellers')); ?>">
