    ...
    <header class="card-header">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 ms-auto text-md-end">
                <form action="<?php echo e(route('vendor.order.updateStatus', $order->order_code)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('VendorDashboard.Vendormaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views/VendorDashboard/order-details.blade.php ENDPATH**/ ?>