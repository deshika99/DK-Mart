        ...
        <div class="row">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a class="itemside" href="#">
                                        <div class="left">
                                            <img src="<?php echo e(asset('/backend/assets/imgs/items/1.jpg')); ?>" width="40" height="40" class="img-xs" alt="Item" />
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <a class="itemside" href="#">
                                        <div class="left">
                                            <img src="<?php echo e(asset('/backend/assets/imgs/items/4.jpg')); ?>" width="40" height="40" class="img-xs" alt="Item" />
                                        </div>
            ...
            <div class="col-lg-4">
                <div class="box shadow-sm bg-light">
                    ...
                    <p>
                        <img src="<?php echo e(asset('/backend/assets/imgs/card-brands/2.png')); ?>" class="border" height="20" /> Master Card **** **** 4768 <br />
