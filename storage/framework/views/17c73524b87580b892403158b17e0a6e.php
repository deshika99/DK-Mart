                    ...
                    <div class="checkout-sidebar">
                        ...
                        <div class="border border-gray-100 rounded-8 px-24 py-40 mt-24">
                            ...
                            <div class="flex-between gap-24 mb-32">
                                ...
                                <span class="text-gray-900 fw-bold text-sm font-heading-two">Rs <?php echo e(number_format($item->subtotal, 2)); ?></span>
                            </div>
                            ...
                            <div class="border-top border-gray-100 pt-30 mt-30">
                                ...
                                <div class="mb-32 flex-between gap-8">
                                    ...
                                    <span class="text-gray-900 font-heading-two text-md fw-semibold">Rs 300.00</span>
                                </div>
                                <div class="mb-0 flex-between gap-8">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\DK-Mart\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>