        ...
        <div class="row gy-4">
            ...
            <div class="col-xl-3">
                <div class="product-details__sidebar py-40 px-32 border border-gray-100 rounded-16">
                    ...
                    <!-- Buy Now Button -->
                    <a href="#" id="buyNowBtn" class="btn btn-outline-main rounded-8 fw-normal mt-16 w-100 <?php if($product->quantity == 0): ?> disabled <?php endif; ?>">
                        Buy Now
                    </a>
                ...
                <div class="product-card__content p-sm-2 w-100">
                    ...
                    <div class="product-card__content mt-12">
                        <div class="product-card__price mb-8">
                            <span class="text-heading text-md fw-semibold ">Rs <?php echo e(number_format($similarProduct->normal_price, 2)); ?><span class="text-gray-500 fw-normal">/Qty</span> </span>
                        </div>
        ...
        <div class="newsletter-box position-relative rounded-16 flex-align gap-16 flex-wrap z-1">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 text-center d-xl-block d-none">
                    <img src="<?php echo e(asset('/frontend/assets/images/thumbs/newsletter-img.png')); ?>" alt="" data-aos="zoom-in" data-aos-duration="800">
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if ((productHasSize && !selectedSize) || (productHasColor && !selectedColor)) {
        ...
        if (<?php echo e($product->quantity); ?> > 0) {
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views\frontend\product-details.blade.php ENDPATH**/ ?>