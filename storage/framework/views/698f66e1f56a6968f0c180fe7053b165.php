...
<div class="profile-dropdown">
    ...
    <a href="<?php echo e(route ('cart')); ?>" class="flex-align flex-column gap-8 item-hover-two">
    <span class="text-2xl text-white d-flex position-relative me-6 mt-6 item-hover__text">
        ...
        <ul class="responsive-dropdown__list scroll-sm p-0 py-8 overflow-y-auto max-h-400">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="has-submenus-submenu" style="width: 240px;">
                    <a href="<?php echo e(url('/shop?category_id=' . $category->id)); ?>" class="text-gray-500 text-15 py-12 px-16 flex-align gap-8 rounded-0">
                    ...
                    <?php if($category->subcategories->isNotEmpty()): ?>
                        <div class="submenus-submenu py-16">
                            <h6 class="text-lg px-16 submenus-submenu__title"><?php echo e($category->name); ?></h6>
...
<!-- ==================== Header End Here ==================== -->
<?php /**PATH C:\xampp\htdocs\DK-Mart\resources\views\includes\navbar-2.blade.php ENDPATH**/ ?>